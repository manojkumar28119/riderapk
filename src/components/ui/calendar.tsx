...
function Calendar({
  ...
  const _weekdaysClassName = cn("flex gap-1", props.weekdaysClassName);
  ...
  const _selectedClassName = cn(
    "[&>button]:bg-brand-primary [&>button]:text-white [&>button]:hover:bg-brand-primary [&>button]:hover:text-primary-foreground",
    props.selectedClassName
  );
  const _todayClassName = cn(
    "[&>button]:bg-blue-200 [&>button]:text-accent-foreground",
    ...
    ({
      ...
      return (
        ...
        >
          ...
          <SelectContent position="popper" align="center" className="max-h-80 overflow-y-auto">
