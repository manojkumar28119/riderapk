...
const sheetVariants = cva(
  "fixed z-50 border border-blue-200 bg-brand-bgwhite shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col px-6 pt-4 space-y-2 text-center sm:text-left",
      className
    )}
    {...props}
  />
